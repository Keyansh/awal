...
class Cms extends Cms_Controller
{
    ...
    public function _category($c_alias = '', $offset = 0)
    {
        ...
        $shell['meta_title'] = $category['meta_title'];
        $shell['meta_keyword'] = $category['meta_keywords'];
        $shell['meta_description'] = $category['meta_description'];
    ...
    public function _product($p_alias = false)
    {
        ...
        $shell['meta_title'] = $product['meta_title'];
