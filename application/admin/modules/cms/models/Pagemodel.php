        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result_array() as $row) {
                if ($row['page_type'] != 'system_page') {
                    ...
                    $output .= '<li id="page_' . $row['page_id'] . '"><div class="page_item"><div class="page_item_name"><a href="' . $edit_href . '">' . $row['title'] . "</a></div>  " . $language . " <div class=\"page_item_options\"><a href=\"" . $block_href . "\"> Manage Blocks</a> | <a href=\"" . $edit_href . "\" class='tooltip-button' data-toggle='tooltip' data-placement='top' title='Edit'><i class='glyph-icon icon-linecons-pencil'></i></a> | <a href=\"" . $del_href . "\" onclick=\"return confirm('Are you sure you want to Delete this Link ?');\" class='tooltip-button' data-toggle='tooltip' data-placement='top' title='Delete'><i class='glyph-icon icon-linecons-trash red-color'></i></a></div></div>";
